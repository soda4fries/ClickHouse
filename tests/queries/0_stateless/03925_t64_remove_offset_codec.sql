...
(
    u8 UInt8,
    t_u8 UInt8 Codec(T64('remove_offset'), ZSTD),
    u16 UInt16,
    t_u16 UInt16 Codec(T64('remove_offset'), ZSTD),
    u32 UInt32,
    t_u32 UInt32 Codec(T64('remove_offset'), ZSTD),
    u64 UInt64,
    t_u64 UInt64 Codec(T64('remove_offset'), ZSTD)
