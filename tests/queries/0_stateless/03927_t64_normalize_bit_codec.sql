...
(
    u8 UInt8,
    t_u8 UInt8 Codec(T64('bit', 'normalize'), LZ4),
    u16 UInt16,
    t_u16 UInt16 Codec(T64('bit', 'normalize'), LZ4),
    u32 UInt32,
    t_u32 UInt32 Codec(T64('bit', 'normalize'), LZ4),
    u64 UInt64,
    t_u64 UInt64 Codec(T64('bit', 'normalize'), LZ4)
